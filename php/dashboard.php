...
<div class="container">
    ...
    <div class="card">
      <img src="../assets/imagens/profs.png" class="card-img-top" alt="turmas">
      <div class="card-body">
        <h5 class="card-title">Turmas</h5>
        <p class="card-text">Visualizar e cadastrar turmas de cada curso</p>
        <a href="tabela_turma.php" class="btn btn-primary">Ver tabela</a>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <p class="card-text">Visualizar a agenda dos professores</p>
